...
\begin{frame}{Activity Streamgraph - Purpose \& Features}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \textbf{Purpose}
            \begin{itemize}
                \item Show activity distribution and normalization over time
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Thin layers harder to interpret
                \item Can be overwhelming with longer date ranges
    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Scrollable timeline for full 15-month or smaller periods
            \end{itemize}
        \end{column}
        \begin{column}{0.48\textwidth}
            \centering
...
% ========== Visualization 4: Participant Comparison ==========
...
\begin{frame}{Visualization 4: Participant Comparison}
    \centering
    \vspace{15pt}
...
% ========== Visualization 5: Building Polygons Overlay ==========
...
\begin{frame}{Visualization 5: Building Polygons Overlay}
    \centering
    \vspace{15pt}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Static representation of spaces
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Lessons Learned}
    \begin{columns}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \setlength{\itemsep}{8pt}
                \item PostGIS is essential for scalable spatial queries
                \item Server-side aggregation beats client-side processing for massive datasets
                \item Strategic data preprocessing dramatically improves query performance
                \item Data quality directly impacts analytical reliability
            \end{itemize}
        \end{column}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \setlength{\itemsep}{8pt}
                \item Multiple perspectives unlock complementary insights
                \item Context integration across visualizations amplifies understanding
                \item Interactive tools empower discovery of hidden patterns
                \item Dual views, individual and aggregate, answer different questions
...
\begin{frame}[t]{Work division} % [t] here moves the content to the top of the slide
    \begin{columns}[t] % [t] here ensures the headers of each column align at the top
        \begin{column}{0.33\textwidth}
            \textbf{Alberto Finardi}
            \begin{itemize}
                \item Infrastructure development
                \item Backend \& Frontend boilerplate
                \item Heatmap implementation
                \item Streamgraph implementation
            \end{itemize}
        \end{column}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{itemize}
                ...
                \item Comparison implementation
        ...
        \begin{column}{0.33\textwidth}
            \textbf{Tom Gave}
            \begin{itemize}
                \item Building polygons implementation
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Repository}
    \centering
    \vspace{2cm}
    {\Large \textbf{Access the Project Repository}}

    \vspace{1.5cm}
    {\faGithub\hspace{0.3cm}\url{https://github.com/albertofinardi/DataVisualisation_Challenge_W25}}

    \vspace{1cm}
    {\normalsize Find our code, documentation, and deployment instructions}
\end{frame}
